...
class DetailedView : Fragment() {
    ...
    override fun onCreateView(
        ...
        transactionViewModel.setDayOfYear(listOf(Calendar.getInstance().get(Calendar.DAY_OF_YEAR),Calendar.getInstance().get(Calendar.YEAR)))

        Log.d("checking", "onCreateView: "+Calendar.getInstance().get(Calendar.MONTH))
